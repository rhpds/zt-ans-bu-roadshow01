...
+
Click **Next** to proceed to the **Define Rules** step. Set the **Frequency** to `Minutely` with an **Interval** of `2`. Click **Save Rule**, then click **Next** through the Exceptions pane and click **Finish** to save the schedule. Your snapshots will now run automatically every two minutes.
+
